...
public class DWRScriptSessionListener implements ScriptSessionListener {
	...
	public static final Map<String, ScriptSession> scriptSessionMap = new HashMap<String, ScriptSession>(100);
...
//System.out.println(session.getId());
	...
	public void sessionDestroyed(ScriptSessionEvent event) {
		...
		// " scriptSession: "+ scriptSession.getId() + "is destroyed!");
	}

	public static void replace(String sessionId,ScriptSession scriptSession){
		scriptSessionMap.put(sessionId,scriptSession);
	}
	...
	public static ScriptSession getScriptSessionByHttpSession(String sessionId){
		return scriptSessionMap.get(sessionId);
	}
}
